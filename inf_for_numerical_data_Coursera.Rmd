...
#Since the confidence level was decreased, the interval got narrower, but less precise
...
#We got a high p-value, therefore we are not able to reject H0 on a 5% significance level.
...
# Simply use the summarise function to get the min value of the mature category
...
# We are 95% confident that newborn girls weight on average between 0.5846 and 0.2126 less than newborn boys.
